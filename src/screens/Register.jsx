    ...
    return (
        ...
        >
            ...
            >
                ...
                <Text style={styles.title}>🥷 Take new journey with <Text fontWeight={'bold'}>Suriken</Text></Text>
                    ...
                    <View>
                        ...
                        <TouchableOpacity style={{ marginTop: 24 }} onPress={() => navigation.navigate('Login')}>
                            <Text color={'purple.500'} textAlign="center">Already have an account? Login here</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </ScrollView>
